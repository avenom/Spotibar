...
* Уровень звука: управление громкостью колесом мыши при наведении на любой элемент плеера, левый клик по шкале звука или по текущему треку выключает/включает звук
...
Если не устраивает способ управления громкостью, то можете установить [7+ Taskbar Tweaker](https://rammichael.com/7-taskbar-tweaker), в котором можно настроить управление громкостью колесом мыши при наведении на панель задач.
